      ...
      <Router>
        <Routes>
          <Route path="/" element={<MainLayout />}>
            ...
            <Route path="flight-book/:key/:id" element={<FlightBook />} />
            <Route path="meal-booking/:id" element={<MealAndSelect />} />
            <Route path="flight-seat-booking/:id" element={<FlightSeatBooking />} />
            <Route path="tickets-payment/:id" element={<FlightsTicketsPaymentPage />} />
