        ...
        <div className="bg-[#f7f7f7]">
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 card bg-white rounded-xl shadow-[0_.5rem_1rem_rgba(0,0,0,0.15)] transition-all duration-300 hover:shadow-lg p-10 my-2 h-fit overflow-auto">
                        <div className="space-y-6">
                            ...
                            <div>
                                <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-2">
                                    <div className="flex flex-col items-center">
                                        ...
                                        <div className="mt-2">
                                            <p className="font-bold">
                                                {flight?.departure ? (`${flight?.departure?.city} (${flight?.departure?.airport})`) : (`${flight?.flightsFrom} (${flight?.fromAirportCode})`)}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-col items-center">
                                        <span>
                                            <img src={flight?.airlineLogo ? `${spechialFlightImage}${flight?.airlineLogo}` : `${spechialFlightImage}${flight?.flightsImage}`} alt="arrival-flight" className="w-32 h-auto" />
                                        </span>
                                        <div className="mt-2">
